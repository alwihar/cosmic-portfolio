...
function Astronaut({ c }: { readonly c: (typeof CHARACTERS)[number]["colors"] }) {
  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.08, 0.24]}>
        ...
        <meshStandardMaterial color={c.stripe} emissive={c.stripe} emissiveIntensity={1} />
      </mesh>
      {/* Belt */}
      <mesh position={[0, -0.18, 0]}>
        <torusGeometry args={[0.28, 0.03, 8, 24]} />
        <meshStandardMaterial color={c.accent} metalness={0.6} roughness={0.3} />
      </mesh>
      {/* Round helmet */}
      ...
      <mesh ref={visorRef} position={[0, 0.56, 0.22]}>
        ...
        <meshStandardMaterial color={c.visor} emissive={c.visorEmissive} emissiveIntensity={1.5} metalness={0.9} roughness={0.1} transparent opacity={0.85} />
      </mesh>
      {/* Helmet rim */}
      ...
      <group ref={antennaRef} position={[0.15, 0.85, 0]}>
        <mesh>
          ...
          <meshStandardMaterial color="#b0b0b8" metalness={0.6} roughness={0.3} />
        </mesh>
        <Float speed={6} floatIntensity={0.3} floatingRange={[0, 0.05]}>
          <mesh position={[0, 0.14, 0]}>
            <sphereGeometry args={[0.04, 8, 8]} />
            <meshStandardMaterial color={c.antenna} emissive={c.antenna} emissiveIntensity={2} toneMapped={false} />
          </mesh>
        </Float>
      </group>
      {/* Arms — thick gloves */}
      <group position={[-0.35, 0.05, 0]} rotation={[0, 0, 0.15]}>
        ...
        <mesh position={[0, -0.22, 0]}>
          ...
          <meshStandardMaterial color={c.accent} metalness={0.3} roughness={0.5} />
        </mesh>
      </group>
      <group position={[0.35, 0.05, 0]} rotation={[0, 0, -0.15]}>
        <mesh castShadow>
      ...
      <mesh castShadow position={[0, 0.05, -0.3]}>
        ...
        <meshStandardMaterial color={c.backpack} metalness={0.4} roughness={0.4} />
      </mesh>
      <group position={[-0.12, -0.17, -0.34]}>
        <mesh>
          <cylinderGeometry args={[0.05, 0.035, 0.12, 8]} />
          <meshStandardMaterial color="#607090" emissive={c.jet} emissiveIntensity={1.2} metalness={0.6} />
        </mesh>
        <pointLight ref={jetLeftRef} position={[0, -0.08, 0]} color={c.jet} intensity={0.8} distance={1.5} />
      </group>
      <group position={[0.12, -0.17, -0.34]}>
        <mesh>
          <cylinderGeometry args={[0.05, 0.035, 0.12, 8]} />
        ...
        <pointLight ref={jetRightRef} position={[0, -0.08, 0]} color={c.jet} intensity={0.8} distance={1.5} />
      </group>
      <mesh position={[0, 0.05, -0.38]}>
        <boxGeometry args={[0.24, 0.04, 0.01]} />
        <meshStandardMaterial color={c.stripe} emissive={c.stripe} emissiveIntensity={1.5} toneMapped={false} />
      </mesh>
    </group>
  );
}
  ...
  return (
    <group>
      ...
      <mesh position={[0, 0.05, 0.151]}>
        ...
        <meshStandardMaterial color={c.stripe} emissive={c.stripe} emissiveIntensity={0.8} />
      </mesh>
      ...
      <mesh ref={screenRef} position={[0, 0.55, 0.151]}>
        ...
        <meshStandardMaterial color={c.visor} emissive={c.visorEmissive} emissiveIntensity={1.2} metalness={0.3} roughness={0.1} />
      </mesh>
      {/* Eye dots on screen */}
      ...
      <group ref={antennaRef} position={[0, 0.76, 0]}>
        ...
        {[0, 1, 2].map((i) => {
          ...
          return (
            <mesh key={i} position={[Math.cos(a) * 0.08, 0.06, Math.sin(a) * 0.08]}>
      ...
      <group position={[-0.32, 0.05, 0]} rotation={[0, 0, 0.1]}>
        ...
        <mesh position={[0, -0.18, 0]}>
          ...
          <meshStandardMaterial color={c.accent} metalness={0.8} roughness={0.1} />
        </mesh>
        {/* Claw hand */}
      ...
      <mesh castShadow position={[0, 0.1, -0.2]}>
        ...
        <meshStandardMaterial color={c.backpack} metalness={0.6} roughness={0.3} />
      </mesh>
  ...
  return (
    <group>
      ...
      <mesh position={[0, -0.05, 0.16]}>
        <sphereGeometry args={[0.08, 8, 8]} />
        <meshStandardMaterial color={c.stripe} emissive={c.stripe} emissiveIntensity={1.5} transparent opacity={0.6} toneMapped={false} />
      </mesh>
      {/* Big dome head */}
      ...
      <mesh ref={eyeLeftRef} position={[-0.12, 0.62, 0.24]}>
        ...
        <meshStandardMaterial color={c.visor} emissive={c.visorEmissive} emissiveIntensity={2} metalness={0.2} roughness={0.1} />
      </mesh>
      {/* Pupil left */}
      ...
      {/* Head spots */}
      {[[-0.2, 0.72, 0.1], [0.22, 0.7, 0.05], [0, 0.82, -0.1]].map(([x, y, z], i) => (
      ...
      <group ref={tentLRef} position={[-0.25, 0.1, 0]}>
        ...
        <mesh position={[-0.03, -0.38, 0]}>
          <sphereGeometry args={[0.035, 6, 6]} />
          <meshStandardMaterial color={c.accent} emissive={c.accent} emissiveIntensity={1} toneMapped={false} />
        </mesh>
      </group>
      {/* Tentacle right arm */}
      ...
      <mesh castShadow position={[0, 0.1, -0.22]}>
        <sphereGeometry args={[0.16, 12, 12, 0, Math.PI * 2, 0, Math.PI / 1.5]} />
        <meshStandardMaterial color={c.backpack} metalness={0.05} roughness={0.7} />
      </mesh>
      {/* Floating energy orbs */}
      <Float speed={4} floatIntensity={0.5} floatingRange={[-0.05, 0.05]}>
        <mesh position={[-0.3, 0.5, 0.15]}>
          <sphereGeometry args={[0.025, 6, 6]} />
          <meshStandardMaterial color={c.antenna} emissive={c.antenna} emissiveIntensity={3} toneMapped={false} />
        </mesh>
      </Float>
